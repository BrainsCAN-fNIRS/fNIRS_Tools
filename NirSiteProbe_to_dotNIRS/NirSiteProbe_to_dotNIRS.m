...
%.needs to be tested whether it also works for atlasviewer
%if this is the case, then the fiducials need to be changed.
%Or a user input can be requested at the start to ask whether it is for
%nirstorm or atlasviewer
%the fiducials I think we need for atlasviewer are commented out around
%line 130. Code needs to be updated so this script can use those too
