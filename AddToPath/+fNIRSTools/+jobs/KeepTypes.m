classdef KeepTypes < nirs.modules.AbstractModule
	...
	%
	%
	% 2022-03-31: Modified from AnalyzIR, added support for numeric wavelength fields
    ...
    methods
        ...
        function data = runThis( obj, data )
            ...
            for i = 1:numel(data)
				...
				if isnumeric(tdata)
					tdata = arrayfun(@num2str, tdata, 'UniformOutput', false);
				end
				if isnumeric(tdata_probe)
					tdata_probe = arrayfun(@num2str, tdata_probe, 'UniformOutput', false);
				end
